...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <h2 className="text-4xl font-bold text-white leading-tight mb-4">
            Start managing<br />
            <span className="text-green-400">your fleet today</span>
          </h2>
          <p className="text-white/50 text-lg max-w-md mb-12">
            Create your account and get instant access to real-time fleet tracking, reports, and alerts.
          </p>
      ...
      {/* Right side - form */}
      <div className="flex-1 flex items-center justify-center p-6 bg-gray-50 lg:p-12 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <p className="text-sm text-gray-500 mb-6">Register to start tracking your fleet</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                />
                <InputField
                  label={<>Phone <span className="text-gray-400 text-xs font-normal">(optional)</span></>}
                  icon={<Phone size={18} />}
                  type="tel"
                  placeholder="+255 700 000"
                  value={form.phone}
